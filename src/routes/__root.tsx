...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "EventNest is the premium way to discover concerts, hackathons, weddings, workshops and more. Beautiful booking, seamless discovery." },
      { name: "author", content: "EventNest" },
      { property: "og:title", content: "EventNest — Smart Event Management Platform" },
      { property: "og:description", content: "Discover, book and celebrate the events that make your calendar unforgettable." },
